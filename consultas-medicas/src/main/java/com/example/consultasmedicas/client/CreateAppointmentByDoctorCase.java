...
public class CreateAppointmentByDoctorCase {
        public static void main(String[] args) {
                ...
                System.out.println("\n-=-=- Criando médicos e paciente -=-=-");

                Doctor clodoaldo = userFactory.criarMedico(1L, "Clodoaldo da Silva", "12345678901",
                                LocalDate.of(1970, 9, 22),
                                "11999999999",
                                "clodoaldo@emai.com", "Rua dos Bobos, 0", "Ortodentista", "130433");
                Patient pacienteCarlos = userFactory.criarPaciente(6L, "Carlos Santos", "123456023934",
                                LocalDate.of(1985, 8, 14),
                                "11982947772", "carlos@email.com", "Rua dos Pinheiros, 78");

                System.out.println("\n-=-=- Adicionando disponibilidade e locais para Clodoaldo -=-=-");

                clodoaldo.adicionarDisponibilidade(
                                new Availability(DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(15, 0)));
                clodoaldo.adicionarDisponibilidade(
                                new Availability(DayOfWeek.WEDNESDAY, LocalTime.of(10, 0), LocalTime.of(18, 0)));

                clodoaldo.adicionarLocal(new Local(2L, "Clínica Sorriso", "Av. das Flores, 101", "11987654321"));

                System.out.println(
                                "\n-=-=- Agendando consulta segunda-feira, às 10h na Clínica Sorriso com Dr. Clodoaldo -=-=-");
