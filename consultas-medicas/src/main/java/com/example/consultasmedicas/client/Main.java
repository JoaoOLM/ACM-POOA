...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        clearScreen();
        System.out.println("Bem-vindo ao sistema de gerenciamento de consultas médicas. Nosso sistema conta com 3 casos de uso atualmente e pode ser testado via" + 
